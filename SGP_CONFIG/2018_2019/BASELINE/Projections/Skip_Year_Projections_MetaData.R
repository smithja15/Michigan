...
SGPstateData[["MI"]][["SGP_Configuration"]][["grade.projection.sequence"]] <- list(
    READING_GRADE_3 = c(3, 6),
    READING_GRADE_4 = c(3, 4, 7),
    READING_GRADE_5 = c(3, 4, 5, 8),
    READING_GRADE_6 = c(3, 4, 5, 6, 9),
    READING_GRADE_7 = c(3, 4, 5, 6, 7, 10),
    READING_GRADE_8 = c(3, 4, 5, 6, 7, 8, 11),
    MATHEMATICS_GRADE_3 = c(3, 6),
    MATHEMATICS_GRADE_4 = c(3, 4, 7),
    MATHEMATICS_GRADE_5 = c(3, 4, 5, 8),
    MATHEMATICS_GRADE_6 = c(3, 4, 5, 6, 9),
    MATHEMATICS_GRADE_7 = c(3, 4, 5, 6, 7, 10),
