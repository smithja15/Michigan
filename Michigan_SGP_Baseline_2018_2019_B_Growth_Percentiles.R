...
sgps.2018_2019 <- grep(".2018_2019.BASELINE", names(Michigan_SGP@SGP[["SGPercentiles"]]))
names(Michigan_SGP@SGP[["SGPercentiles"]])[sgps.2018_2019] <- gsub(".2018_2019.BASELINE", ".2018_2019.SKIP_YEAR_BLINE", names(Michigan_SGP@SGP[["SGPercentiles"]])[sgps.2018_2019])
